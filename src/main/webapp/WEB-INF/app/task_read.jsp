    ...
    <jsp:attribute name="content">
        <form method="post" class="stacked">
            <div class="column">
                ...
                <div class="side-by-side">
                    <select name="task_category">
                        ...
                        <c:forEach items="${categories}" var="category">
                            <option value="${category.id}" ${task_form.values["task_category"][0] == category.id ? 'selected' : ''} readonly="readonly">
                ...
                <div class="side-by-side margin">
                    <select name="task_status">
                        <c:forEach items="${statuses}" var="status">
                            <option value="${status}" ${task_form.values["task_status"][0] == status ? 'selected' : ''} readonly="readonly">
                ...
                <div class="side-by-side">
                    <textarea readonly name="task_long_text"><c:out value="${task_form.values['task_long_text'][0]}"/></textarea>
                </div>
                ...
                <div class="side-by-side margin">
                    <select name="price_status">
                        <c:forEach items="${types}" var="typ">
                            <option value="${typ}" ${task_form.values["price_status"][0] == typ ? 'selected' : ''} readonly="readonly">
                    ...
                    <div class="side-by-side">
                        <input type="text" name="task_preis" value="${task_form.values["task_preis"][0]}" readonly="readonly">
                    </div>
                </div>
